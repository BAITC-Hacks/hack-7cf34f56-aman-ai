# moneygraph-seed-convergence

## Purpose
Implement distinct-seed reachability with deterministic per-seed BFS and integer bitmasks.
...
- Sort seed gids and adjacency lists; BFS the complete directed graph with a visited
  set for each seed, OR its bit into reached nodes, and keep all cross-level edges.
...
Float-coercing gids; reversing edges; using transactions as canonical topology; depth-ordered
propagation on this cyclic graph; counting paths instead of distinct seeds; nondeterministic Louvain/ordering; terminal labeling at depth 4; scores outside
