...
- **AI ограничен доступными инструментами и выборками.** В Python Investigator реализованы ограниченные поиски путей, общих потомков и календарных признаков; при исчерпании лимитов результат не считается полным. Ответы зависят от доступности внешних API и действующих ключей; отдельная проверка NVIDIA в браузерном помощнике не гарантирует правильность вывода.
