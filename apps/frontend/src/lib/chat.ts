...
const statusSchema = z.object({ available: z.boolean(), reviewerAvailable: z.boolean(), dataMode: z.enum(['project', 'demo', 'api']) })
const replySchema = z.object({
  answer: z.string().min(1), dataMode: z.enum(['project', 'demo', 'api']),
