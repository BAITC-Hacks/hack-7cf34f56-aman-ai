...
def make_evidence(row)->str:
 ...
 elif r=="coordinator": text=f"Структурно значимый узел: PageRank {row.pagerank_pct:.2f}, betweenness {row.betweenness_pct:.2f}, достижим из {row.seed_reach_count} seed-узлов."
