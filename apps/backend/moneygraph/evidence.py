...
def make_evidence(row)->str:
 ...
 elif r=="coordinator": text=f"Структурно значимый узел: процентили PageRank {row.pagerank_pct:.2f}, betweenness {row.betweenness_pct:.2f} в своей depth-группе; {row.seed_reach_count} seed-веток."
