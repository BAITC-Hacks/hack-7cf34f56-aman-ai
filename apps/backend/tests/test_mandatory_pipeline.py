...
def test_priority_resilience_and_evidence():
 ...
 f=pd.DataFrame([row('S',role='peripheral',role_score=.2,seed_convergence=0,observed_volume_pct=0,pagerank_pct=0,betweenness_pct=0),row('A',role='coordinator',role_score=1,seed_convergence=1,observed_volume_pct=1,pagerank_pct=1,betweenness_pct=1),row('B',role='peripheral',role_score=.2,seed_convergence=.1,observed_volume_pct=.1,pagerank_pct=.1,betweenness_pct=.1)])
